...
import static Vistas.RegistrarDatos_1Controller.pila;
 ...
 * @author Miguel Angel
 */
public class RegistrarDatos_2Controller implements Initializable {
    ...
    private void actionEvent(ActionEvent e) {
        ...
        if(evt.equals(btnRegistrar)){
            ...
            datos2 prod = new datos2(nom, apell, telefono, direccion, departamento);
            pila.setPushProducto(prod);
            loadStage("/Vistas2/PaginaPrincipal_2.fxml", e);
            
        
       }
        if(evt.equals(btnBack)){
            loadStage("/ViewInicio/CarritoCompras3.fxml", e);
        }
    }
