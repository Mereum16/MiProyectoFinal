 ...
 * @author Miguel Angel
 */
public class Finalizar_2Controller implements Initializable {
    ...
    private Stage stage;
    private Pagar_2Controller controllerPagar_2;
    ...
    void initialize(String text, String text2, String text3, Stage stage, Pagar_2Controller aThis) {
        lblPago.setText(text);
        lblCuenta.setText(text2);
        lblTel.setText(text3);
       this.controllerPagar_2 = aThis;
        this.stage = stage;
    }
