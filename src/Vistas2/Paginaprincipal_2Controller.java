...
import static Vistas.Paginaprincipal_1Controller.Productos;
import static Vistas.Paginaprincipal_1Controller.pilaP;
 ...
 * @author Miguel Angel
 */
public class Paginaprincipal_2Controller implements Initializable {
    static public objSTACK pilaP = new objSTACK();
    RegistrarDatos_2Controller registro = new RegistrarDatos_2Controller();
   ...
   public static ObservableList<datos2> Productos = FXCollections.observableArrayList();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        Vistas2.RegistrarDatos_2Controller.pila = pilaP;
    ...
    private void actionEvent(ActionEvent e) {
        ...
        if(evt.equals(btnRegistrar)){
            loadStage("/Vistas2/RegistrarDatos_2.fxml", e);
        }
        if(evt.equals(btnPagar)){
            loadStage("/Vistas2/Pagar_2.fxml", e);
        }
