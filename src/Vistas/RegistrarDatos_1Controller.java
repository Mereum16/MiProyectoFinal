...
import static Vistas.RegistrarDatosController.pila;
 ...
 * @author Miguel Angel
 */
public class RegistrarDatos_1Controller implements Initializable {
    ...
    private void actionEvent(ActionEvent e) {
        ...
        if(evt.equals(btnRegistrar)){
            ...
            loadStage("/Vistas/PaginaPrincipal_1.fxml", e);
            
        
       }
        if(evt.equals(btnBack)){
            loadStage("/ViewInicio/CarritoCompras2.fxml", e);
        }
