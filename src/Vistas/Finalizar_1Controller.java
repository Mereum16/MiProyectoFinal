 ...
 * @author Miguel Angel
 */
public class Finalizar_1Controller implements Initializable {
    ...
    private Stage stage;
    private Pagar_1Controller controllerPagar_1;
    ...
    void initialize(String text, String text2, String text3, Stage stage, Pagar_1Controller aThis) {
        lblPago.setText(text);
        lblCuenta.setText(text2);
        lblTel.setText(text3);
       this.controllerPagar_1 = aThis;
        this.stage = stage;
    }
